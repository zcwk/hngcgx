package com.zdzyc.ssm.interceptor;
            ...
            if(null!=cookies){
                for(Cookie cookie : cookies){
                    ...
                    if("UserPhone".equals(cookie.getName())){
                        loginCookieUserPhone = cookie.getValue();
                    }else if("UserPwd".equals(cookie.getName())){
                        loginCookiePassword = cookie.getValue();
                    }
                    //}
                }
                if(!"".equals(loginCookieUserPhone) && !"".equals(loginCookiePassword)){
                    User user = userService.selectByUserPhone(loginCookieUserPhone);
                    if(loginCookiePassword.equals(user.getUserPwd())){
